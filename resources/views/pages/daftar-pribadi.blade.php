                ...
                <div class="row">
                    ...
                    <div class="multisteps-form">
                        ...
                        <div class="col-12 col-lg-10 m-auto">
                            <form class="multisteps-form__form mb-8" method="POST" action="{{ url('daftar-pribadi') }}">
                                    ...
                                    <div class="multisteps-form__content">
                                      ...
                                      <div class="row mt-3">
                                        ...
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="judul_buku_latin" rows="4" cols="2" required="required" > </textarea>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                     ...
                                     <div class="row mt-3">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <textarea class="multisteps-form__input form-control" name="hafalan_juzamma" rows="5" cols="5" placeholder="sebutkan nama suratnya" required="required"> </textarea>
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Sebutkan doa harian yang sudah dihafal</label>
                                            <textarea class="multisteps-form__input form-control" name="doa_harian_hafal" rows="5" cols="5" placeholder="sebutkan nama suratnya" required="required"> </textarea>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Kesukaan atau hobi anak pada bidang atau kegiatan tertentu</label>
                                            <textarea class="multisteps-form__input form-control" name="hobi" rows="5" cols="5" placeholder="sebutkan nama suratnya" required="required"> </textarea>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input class="multisteps-form__input form-control" name="jumlah_penghuni_dewasa" type="number" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                      </div> 
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                            <label class="mt-2">Jumlah penghuni anak-anak di rumah</label>
                                            <input class="multisteps-form__input form-control" name="jumlah_penghuni_anak" type="number" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                       <div class="col-sm-6 mt-sm-0 mt-4">
                                        ...
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="selera_makan" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="kebiasan_tidur_malam" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6">
                                          <label>Kebiasaan bangun pagi pada umumnya pukul</label>
                                          <input class="multisteps-form__input form-control" name="kebiasan_bangun_pagi" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                          <label>Kebiasaan tidur siang pada umumnya pukul</label>
                                          <input class="multisteps-form__input form-control" name="kebiasan_tidur_siang" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="hal_penting_waktu_tidur" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="hal_penting_tingkahlaku_anak" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="sifat_baik" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                          <label>Sifat buruk anak</label>
                                          <input class="multisteps-form__input form-control" name="sifat_buruk" type="text" placeholder="eg. Off-White"  required="required"/>
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
