                                    ...
                                    <h6 class="font-weight-bolder">Ayah</h6>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="nama_ayah" type="text" placeholder="eg. Off-White"  required />
                                        </div>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="tempat_lahir_ayah" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                      ...
                                      <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="alamat_ayah" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Alamat Kantor</label>
                                            <input class="multisteps-form__input form-control" name="alamat_kantor_ayah" type="text" placeholder="no telepon" required />
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Rumah</label>
                                            <input class="multisteps-form__input form-control" name="nomor_telepon_rumah_ayah" type="text"  placeholder="no telepon" required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Kantor</label>
                                            <input class="multisteps-form__input form-control" name="nomor_telepon_kantor_ayah" type="text"  placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor WhatsApp</label>
                                            <input class="multisteps-form__input form-control" name="no_whatsapp_ayah" type="text"  placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <p></p>
                                      ...
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          <label>Nama lengkap</label>
                                          <input class="multisteps-form__input form-control" name="nama_ibu" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Tanggal Lahir</label>
                                      ...
                                      <div class="col-12 col-sm-6">
                                          <label>Tempat Lahir</label>
                                          <input class="multisteps-form__input form-control" name="tempat_lahir_ibu" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Pekerjaan</label>
                                            <?php 
                                      ...
                                      <div class="col-12 col-sm-6">
                                          <label>Alamat Rumah</label>
                                          <input class="multisteps-form__input form-control" name="alamat_ibu" type="text" placeholder="eg. Off-White" required />
                                        </div>
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Alamat Kantor</label>
                                            <input class="multisteps-form__input form-control" name="alamat_kantor_ibu" type="text" placeholder="no telepon" required />
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Rumah</label>
                                            <input class="multisteps-form__input form-control" name="nomor_telepon_rumah_ibu" type="text" placeholder="no telepon" required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor telepon Kantor</label>
                                            <input class="multisteps-form__input form-control" name="nomor_telepon_kantor_ibu" type="text" placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Nomor Whatsapp</label>
                                            <input class="multisteps-form__input form-control" name="no_whatsapp_ibu" type="text" placeholder="no telepon" required />
                                        </div>
                                      </div>
                                      <p></p>
