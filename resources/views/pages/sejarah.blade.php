...
<div class="banner-thumbnail" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="400">
    <img class="paralax-image" src="{{ asset('assets/front-app/media/others/halaman.png')}}" alt="Illustration">
</div>
</div>
</div>
</div>
...
<img src="{{ asset('assets/front-app/media/others/line-4.png')}}" alt="Line">
</li>
</ul>
</div>
<!--=====================================-->
