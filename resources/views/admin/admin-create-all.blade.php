                                    ...
                                    <div class="multisteps-form__content">
                                      <div class="row mt-3">
                                        <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" value="" name="nama_peserta" type="text" placeholder="eg. Off-White"  required />
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                          <label>Nama Panggilan</label>
                                          <input class="multisteps-form__input form-control" name="nama_panggilan" type="text" placeholder="eg. Off-White" required  />
                                        </div>
                                      </div>
                                      <div class="row mt-3">
                                        <div class="col-sm-6 mt-sm-0 mt-4">
                                          ...
                                          <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <label>Usia</label>
                                            <input class="multisteps-form__input form-control" name="usia_peserta" type="number" placeholder="eg. Off-White"  required/>
                                          </div>
                                      </div>
                                      <div class="row mt-3">
                                      <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                      ...
                                      <div class="row mt-3">
                                       <div class="col-12 col-sm-6">
                                          ...
                                          <input class="multisteps-form__input form-control" name="jumlah_saudara_kandung" type="number" placeholder="eg. Off-White"  required/>
                                        </div>
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
